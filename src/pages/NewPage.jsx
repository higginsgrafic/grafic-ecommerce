      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center">
            ...
            >
              <Bell className="w-16 h-16 mx-auto mb-6 text-purple-400" />
              ...
              <form className="max-w-md mx-auto">
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-grow px-6 py-4 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-purple-400 font-roboto text-[14pt]"
                    required
                  />
                  <button
                    type="submit"
                    className="bg-purple-600 text-white px-8 py-4 rounded-lg font-roboto text-[14pt] font-medium hover:bg-purple-700 transition-colors flex-shrink-0"
                  >
                    Subscriu-te
                  </button>
                </div>
