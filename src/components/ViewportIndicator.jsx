...
function ViewportIndicator({ visible = true, onClose }) {
  ...
  const getDeviceType = (width) => {
    ...
    if (width < 1920) return { type: 'Desktop', icon: Monitor, color: 'bg-purple-500' };
  ...
  const ViewportFrame = () => (
    <>
      {/* Marc superior */}
      <div className="fixed top-0 left-0 right-0 h-0 border-t-4 border-blue-500 z-50 pointer-events-none"
      ...
      {/* Marc inferior */}
      <div className="fixed bottom-0 left-0 right-0 h-0 border-b-4 border-blue-500 z-50 pointer-events-none"
           style={{ boxShadow: '0 0 20px rgba(59, 130, 246, 0.5)' }}>
      ...
      {/* Marc esquerre */}
      <div className="fixed top-0 bottom-0 left-0 w-0 border-l-4 border-green-500 z-50 pointer-events-none"
      ...
      {/* Marc dret */}
      <div className="fixed top-0 bottom-0 right-0 w-0 border-r-4 border-green-500 z-50 pointer-events-none"
           style={{ boxShadow: '0 0 20px rgba(34, 197, 94, 0.5)' }}>
      ...
      <div className="fixed top-2 left-2 bg-gradient-to-br from-purple-600 to-blue-600 text-white rounded-lg shadow-xl z-50 pointer-events-none px-3 py-2">
      ...
      {onClose && (
        <button
          onClick={onClose}
          className="fixed top-2 right-2 bg-red-500 hover:bg-red-600 text-white rounded-full p-2 shadow-xl z-50 transition-all hover:scale-110"
