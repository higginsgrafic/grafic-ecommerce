...
// Sempre utilitzem la icona del cistell personalitzada: /cart-icon.png
...
const Cart = ({ isOpen, onClose, items, onUpdateQuantity, onRemove, totalPrice, onCheckout, onUpdateSize }) => {
  ...
  // Bloquejar scroll del body quan el cart està obert
  useEffect(() => {
    if (isOpen) {
          ...
          >
              ...
              {items.length === 0 ? (
                ...
                <AnimatePresence mode="popLayout">
                  {sortedItems.map((item, index) => (
                    ...
                    layout
                  >
                    {/* Image - MÉS GRAN I CLARA (responsiva) */}
            ...
            {items.length > 0 && (
              <div className="p-4 sm:p-6 border-t bg-gray-50 space-y-4">
                {/* Total - Mateixa mida que preu, Regular */}
                ...
                {/* Botons un al costat de l'altre */}
